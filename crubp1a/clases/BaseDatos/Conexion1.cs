...
namespace crubp1a.clases.BaseDatos
{
    public class Conexion1
    {
        ...
        public Conexion1()
        {
            ...
            _conexion = "Data Source=UMG-VM\\SQLEXPRESS;Initial Catalog=dbprogra2a;Integrated Security=True";
        ...
        internal static void obtenerConexion(object _)
        {
